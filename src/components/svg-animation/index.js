        ...
        <div id="contain-all-moon">
            <svg style={{isolation:"isolate"} }viewBox="0 0 400 400" width="100%" height="100%">
                ...
                <g id="mountain-group">
                    ...
                    <path d="M 0 400 H -100 l 20.976 -79.41 l 20.976 -79.41 l 12.831 48.577 l 8.284 -38.927 l 5.314 24.974 l 19.83 -93.182 l 15.769 74.1 L 50 400 z" id="mountain-3" fill="#171717" />
                    <path d="M 400 400 H 296.02 l 20.976 -79.41 l 20.976 -79.41 l 12.831 48.577 l 8.284 -38.927 l 5.314 24.974 l 19.83 -93.182 l 15.769 74.1 L 450 400 z" id="mountain-2" fill="#171717" />
